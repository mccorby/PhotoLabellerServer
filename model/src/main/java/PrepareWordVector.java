...
public class PrepareWordVector {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String classPathResource = "/Users/jco59/ML/TechConf-2018";
        String filePath = new File(classPathResource + File.separator + "synopsis.txt").getAbsolutePath();
        ...
        WordVectorSerializer.writeWordVectors(vec.lookupTable(), classPathResource + "SynopsisWordVector.txt");
    }
}
